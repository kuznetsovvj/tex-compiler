namespace TexCompiler.Services
{
    ...
    ///
    /// Значение читается из конфигурации по образцу CleanupSettings в CleanupService.
    /// </summary>
    public static class UploadLimits
    {
        ...
        /// без запаса файл ровно в лимит обрывался бы на последних байтах — и вместо
        /// внятного сообщения из контроллера пользователь получал бы 413.
        /// </summary>
        ...
        /// <summary>
        /// Порог, на котором Kestrel обрывает приём тела. Заведомо больше лимита на файл:
        /// грубый барьер против заведомо чужих запросов, а точную границу проверяет
        /// контроллер, у которого есть возможность объяснить отказ.
        /// </summary>
